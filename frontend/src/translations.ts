      ...
      server: {
        ...
        files: {
          ...
          searchBanner: {
            ...
            maxSearchSize: 'Files above {size} are skipped',
          ...
          toast: {
            ...
            closeDestinationBeforeCreate: 'Close the editor tab for the destination file before creating this file.',
