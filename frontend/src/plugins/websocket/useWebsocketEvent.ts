...
export enum SocketEvent {
  ...
  DATABASE_BACKUP_RESTORE_STARTED = 'database backup restore started',
  DATABASE_BACKUP_RESTORE_PROGRESS = 'database backup restore progress',
  DATABASE_BACKUP_RESTORE_COMPLETED = 'database backup restore completed',
