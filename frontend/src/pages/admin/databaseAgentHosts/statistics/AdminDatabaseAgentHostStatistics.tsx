...
export default function AdminDatabaseAgentHostStatistics({
  ...
  const [stats, setStats] = useState<HostStatistics | null>(null);
  ...
  useEffect(() => {
    ...
    const connect = () => {
      ...
      const url = new URL(
        `/api/admin/database-agent-hosts/${databaseAgentHost.uuid}/system/stats/ws`,
      ...
      socket.onmessage = (event) => {
        ...
        try {
          const data = transformKeysToCamelCase(JSON.parse(event.data)) as HostStatistics & {
