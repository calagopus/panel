...
import FileTreeName from '@/pages/server/files/FileTreeName.tsx';
import {
  FileTreeEditorSelection,
  getFileTreeEditorTabId,
  setFileTreeEditorTabDragData,
} from '@/pages/server/files/fileTreeEditor.ts';
...
export default function FileTreeEditorTabs({
  ...
  return (
    <div
      ...
      className='file-manager-editor-tabs flex shrink-0 overflow-x-scroll overflow-y-hidden border-b border-(--mantine-color-default-border)'
    >
      {tabs.map((tab) => {
        ...
        return (
          <div
            ...
            className={classNames(
              'file-manager-editor-tab group flex min-w-0 max-w-(--file-manager-tab-max-width) shrink-0 cursor-grab items-center overflow-hidden border-r border-(--mantine-color-default-border) active:cursor-grabbing',
              active
          ...
          >
            <UnstyledButton
              ...
              className='flex min-w-0 flex-1 items-center gap-(--file-manager-tab-gap) overflow-hidden py-2 pl-(--file-manager-tab-padding-inline)! text-sm'
            >
            ...
            <ActionIcon
              ...
              variant='subtle'
              color='gray'
              className='mr-(--file-manager-tab-close-margin) shrink-0'
