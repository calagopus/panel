...
mod get {
    ...
    struct Response {
        ...
        instances: Pagination<
            shared::models::server_database_instance::AdminApiServerServerDatabaseInstance,
        >,
    }
    ...
    pub async fn route(
        ...
        ApiResponse::new_serialized(Response {
            instances: instances
                .try_async_map(|database_agent| database_agent.into_admin_server_api_object(&state))
                .await?,
        })
        .ok()
    }
