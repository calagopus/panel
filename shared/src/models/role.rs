...
impl CreatableModel for Role {
    ...
    async fn create_with_transaction(
        ...
        Self::run_after_create_handlers(&mut role, &options, state, transaction).await?;
...
impl UpdatableModel for Role {
    ...
    fn get_update_handlers() -> &'static LazyLock<UpdateHandlerList<Self>> {
        static UPDATE_LISTENERS: LazyLock<UpdateHandlerList<Role>> =
            LazyLock::new(|| Arc::new(ModelHandlerList::default()));
...
impl DeletableModel for Role {
    ...
    fn get_delete_handlers() -> &'static LazyLock<DeleteHandlerList<Self>> {
        static DELETE_LISTENERS: LazyLock<DeleteHandlerList<Role>> =
            LazyLock::new(|| Arc::new(ModelHandlerList::default()));
